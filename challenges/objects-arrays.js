...
// const unisWithUni = graduates.forEach((arr)=> {
//   var uniwithuni = [], i;
//     for(i = 0; i < arr.length; i++)
//         if (arr[i] === "uni")
//             uniwithuni.push(i);
//     return uniwithuni;})
// console.log(uniWithUnis(graduates));
...
const lowCaseAnimalNames = zooAnimals.map((lowCase)=>{
  return lowCase.animal_name.toLocaleLowerCase();
});
